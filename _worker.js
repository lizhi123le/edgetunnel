...
class TlsClient {
	...
	async encryptTls13Handshake(plaintext) {
		...
		return TLS_AES_GCM加密(this.clientHandshakeCryptoKey, nonce, plaintext, additionalData);
	}
        ...
        async encryptTls13(data) {
            ...
            return TLS_AES_GCM加密(this.clientAppCryptoKey, nonce, plaintext, additionalData);
        }
