# 合并冲突报告
## 冲突时间: Fri May  8 00:36:06 UTC 2026
## 上游更新哈希: 775b6f3734d6fc76d1143ecd4f11567797180dfca296909d0ed22dca70169dd5

以下文件包含冲突标记，需要手动解决：

```
<<<<<<< local_worker.js
const Version = '2026-05-06 17:51:02(Enhanced)';
=======
...
async function SOCKS5可用性验证(代理协议 = 'socks5', 代理参数) {
    ...
    try {
        ...
        if (代理协议 === 'socks5') {
            ...
            tcpSocket = await httpConnect('check.socks5.090227.xyz', 80, initialData, 代理协议 === 'https');
        }
